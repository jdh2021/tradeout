                        ...
                        <TableBody>
                        {
                            ...
                            <TableRow>
                                ...
                                <TableCell align="left">
                                    <Button target="_blank" rel="noopener noreferrer" variant="contained" color="green" href={contractDetails.contract_receipt} sx={{textDecoration: 'underline'}}>View Contract PDF</Button></TableCell>
                            </TableRow> :
                            <></>
                        }
                        <TableRow>
