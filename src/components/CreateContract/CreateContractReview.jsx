        ...
        <Container sx={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
          <TableContainer elevation={10} component={Paper} sx={{width: 700}}>
            <Table>
              <TableBody>
                <TableRow>
                  <TableCell align="left"><Typography>Contract Title:</Typography></TableCell>
                ...
                <TableRow>
                  <TableCell align="left"><Typography>Item Description:</Typography></TableCell>
                  <TableCell align="left">{newContractDetails.itemDescription}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Item Price:</Typography></TableCell>
                  <TableCell align="left">${newContractDetails.itemPrice}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Pickup Location:</Typography></TableCell>
                  <TableCell align="left">{newContractDetails.pickupLocation}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Pickup Date:</Typography></TableCell>
                  <TableCell align="left">{formattedPickupDate}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Contract Deadline:</Typography></TableCell>
                  <TableCell align="left">{formattedContractDeadline}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Notes:</Typography></TableCell>
                  <TableCell align="left">{newContractDetails.contractNotes}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Your Signature:</Typography></TableCell>
                  <TableCell align="left">{newContractDetails.firstPartySignature}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="left"><Typography>Images:</Typography></TableCell>
